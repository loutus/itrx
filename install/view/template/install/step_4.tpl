...
<div class="container">
  ...
  <div class="support text-center">
    <div class="row">
      ...
      <div class="col-sm-4"><a href="http://opencartcms.org/" class="icon transition"><i class="fa fa-comments fa-4x"></i></a>
        <h3><?php echo $text_forum; ?></h3>
        <p><?php echo $text_forum_description; ?></p>
        <a href="http://opencartcms.org/"><?php echo $text_forum_visit; ?></a></div>
      <div class="col-sm-4"><a href="http://forum.opencart.com/" class="icon transition"><i class="fa fa-user fa-4x"></i></a>
        <h3><?php echo $text_commercial; ?></h3>
        <p><?php echo $text_commercial_description; ?></p>
        <a href="http://forum.opencart.com/" target="_BLANK"><?php echo $text_commercial_visit; ?></a></div>
    </div>
  </div>
</div>
<?php echo $footer; ?> 